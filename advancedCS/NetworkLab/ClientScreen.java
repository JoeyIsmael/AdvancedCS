...
public class ClientScreen extends JPanel implements ActionListener,MouseListener{
    ...
    public void paintComponent(Graphics g){
        ...
        g.drawString("You are Player 1",600,50);
        ...
        for (int i=0;i<9 ;i++ ) {
            for (int r=0;r<3;r++) {
                for(int c=0;c<3;c++){
                    if(grid.checkSquare(r,c,i).equals("X")){
                    ...
                    else if(grid.checkSquare(r,c,i).equals("O")){
